...
const TaskDtoSchema = CollectionSchema(
  ...
  links: {
    r'categories': LinkSchema(
      id: -2584285656238414244,
      name: r'categories',
      target: r'CategoryDto',
      single: false,
    )
  },
  embeddedSchemas: {},
...
void _taskDtoAttach(IsarCollection<dynamic> col, Id id, TaskDto object) {
  object.id = id;
  object.categories
      .attach(col, col.isar.collection<CategoryDto>(), r'categories', id);
}
...
extension TaskDtoQueryWhereSort on QueryBuilder<TaskDto, TaskDto, QWhere> {
  ...
  QueryBuilder<TaskDto, TaskDto, QAfterWhere> anyUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskDtoQueryWhere on QueryBuilder<TaskDto, TaskDto, QWhereClause> {
  ...
  QueryBuilder<TaskDto, TaskDto, QAfterWhereClause> updatedAtEqualTo(
      DateTime updatedAt) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskDto, TaskDto, QAfterWhereClause> updatedAtNotEqualTo(
      DateTime updatedAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<TaskDto, TaskDto, QAfterWhereClause> updatedAtGreaterThan(
    DateTime updatedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskDto, TaskDto, QAfterWhereClause> updatedAtLessThan(
    DateTime updatedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskDto, TaskDto, QAfterWhereClause> updatedAtBetween(
...
extension TaskDtoQueryLinks
    on QueryBuilder<TaskDto, TaskDto, QFilterCondition> {
  QueryBuilder<TaskDto, TaskDto, QAfterFilterCondition> categories(
      FilterQuery<CategoryDto> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'categories');
    });
  }

  QueryBuilder<TaskDto, TaskDto, QAfterFilterCondition> categoriesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskDto, TaskDto, QAfterFilterCondition> categoriesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'categories', 0, true, 0, true);
    });
  }

  QueryBuilder<TaskDto, TaskDto, QAfterFilterCondition> categoriesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskDto, TaskDto, QAfterFilterCondition> categoriesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
